...
const SidebarNavTitle = (props: PropsWithChildren<any>) => {
  ...
  return (
    <ul className="list-unstyled">
      <SidebarNavGroup toggleIcon={faFutbol} toggleText="Player Manager">
        ...
        <SidebarNavItem href="/team">Team</SidebarNavItem>
        <SidebarNavItem href="/season">Season</SidebarNavItem>
        <SidebarNavItem href="/trait">Trait</SidebarNavItem>
      </SidebarNavGroup>
      <SidebarNavItem icon={faNewspaper} href="/blogs">
        Blogs
      </SidebarNavItem>
      <SidebarNavItem icon={faCartShopping} href="/shop">
        Shop
      </SidebarNavItem>
    </ul>
  );
