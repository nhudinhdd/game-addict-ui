...
export default function useSWRAxios<T>(
  ...
  const fallbackData: AxiosResponse<T> = {
    ...initFallbackData,
    ...axiosFallbackData,
  };
    ...
    () => axios.request<T>(axiosRequest),
    {
      ...
      onErrorRetry: (
        ...
        const maxRetry = parseInt(
          process.env.NEXT_PUBLIC_API_MAX_RETRY ?? "5",
          10
        );
        ...
        const retryInterval = parseInt(
          process.env.NEXT_PUBLIC_API_RETRY_INTERVAL_IN_SECONDS ?? "5",
          10
        );
...
export const transformResponseWrapper = (
